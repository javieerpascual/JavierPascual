...
public class JavierPascual_Pintar {
	public String nombreCuadro;
	public int nColores;
	public String nombreHobby;
	public String nombrePintor;
	public int medidasCuadro;
	public int precioCuadro;
	
	public JavierPascual_Pintar(String nombreCuadro, int nColores, String nombreHobby, String nombrePintor, int medidasCuadro, int precioCuadro) {
		super();
